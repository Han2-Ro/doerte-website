...
>
    ...
    <div class="p-sm lg:w-3/5">
        <h2 class="font-bold">Thomas Hübl</h2>
        <p class="pt-sm">
            Numbness – Nicht-fühlen ist ein aktiver Prozess, der Energie
            verbraucht (englisch)
        </p>
        <a
            class="text-blue-600 hover:text-blue-500 decoration-2 hover:underline focus:outline-none focus:underline"
            href="https://www.youtube.com/watch?v=wb37N48pEDs&list=PLOniOpzM7P2IjLJxEpBrr8ocJt-z375rb&index=15"
        >
        ...
        <p class="pt-sm">Warum Trauma kein Defizit ist | Thomas Hübl</p>
        <a
            class="text-blue-600 hover:text-blue-500 decoration-2 hover:underline focus:outline-none focus:underline"
            href="https://www.youtube.com/watch?v=wH0tdfp_tVA"
        >
        ...
        <a
            class="text-blue-600 hover:text-blue-500 decoration-2 hover:underline focus:outline-none focus:underline"
            href="https://www.zeit.de/serie/ist-das-normal"
        >
        ...
        <a
            class="text-blue-600 hover:text-blue-500 decoration-2 hover:underline focus:outline-none focus:underline"
            href="https://www.melanie-buettner.de/sexpodcast-zeit-online-ist-das-normal/"
        >
            https://www.melanie-buettner.de/sexpodcast-zeit-online-ist-das-normal/
        </a>
    </div>
</section>
...
<style>
    #quote {
        background-image: url($lib/assets/forest_1280.webp);
