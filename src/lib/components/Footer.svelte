<footer class="py-lg bg-logo-purple/20 text-center">
    ...
    <div class="flex flex-col lg:hidden gap-xs px-sm">
    ...
    <p class="pt-sm text-gray-700 text-sm">
        <a href="/datenschutz" class="underline hover:no-underline"
            >Datenschutz</a
        >
