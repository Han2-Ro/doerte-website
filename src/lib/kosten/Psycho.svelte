<section class="pt-xl max-w-[80rem] mx-auto flex flex-col-reverse lg:flex-row">
    ...
    <div class="lg:w-3/5 p-sm">
        ...
        <div class="text-sm">
        <p>Freie Methoden- und Therapeutenauswahl:
            ...
            Sie können unter allen Methoden frei wählen.
        </p>
        <p class="pt-xs">Frequenz und Therapiedauer können frei gewählt werden</p>
        <p class="pt-xs">Relativ kurzfristige Termine und keine monatelangen Wartezeiten</p>
        <p class="pt-xs">
            Überbrückung der Wartezeit bis zum Beginn einer kassenfinanzierten
            Therapie
        </p>
        <p class="pt-xs">Behandlung und Diagnose werden nicht aktenkundig.</p>
        </div>
    </div>
</section>
