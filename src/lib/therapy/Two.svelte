...
>
    <div id="quote" class="lg:w-2/5 flex flex-col-reverse min-h-[35rem] p-xs">
        <div
    ...
    <div class="px-sm pb-md lg:w-3/5">
        <h1 class="pb-md text-2xl font-handwriting italic text-logo-purple">
        ...
        <table class="w-full border-collapse text-left mt-sm text-sm">
            <thead>
                <tr class=" bg-logo-purple/20">
        ...
        <h1
            class=" pt-lg pb-xs text-2xl font-handwriting italic text-logo-purple"
        >
            Ausfallsregelung
        </h1>
        <p>
            Ich bitte darum, Termine, die nicht eingehalten werden können,
