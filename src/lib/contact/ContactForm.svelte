<section
    class="flex flex-col lg:flex-row gap-md max-w-[80rem] mx-auto px-xs lg:px-sm pt-2xl"
>
    <div>
        <h1 class=" text-xl font-bold mb-md">Kontakt</h1>
        <p class="mb-sm">Dörte Brügmann</p>
        <a class="flex" href="https://maps.app.goo.gl/pyJ6VsstLssM5WvH9">
            <svg
        ...
        <a class="flex" href="mailto:kontakt@praxis-bruegmann.de">
            <svg
                xmlns="http://www.w3.org/2000/svg"
                height="24px"
                viewBox="0 -960 960 960"
                ...
                /></svg
            >
            <p>kontakt@praxis-bruegmann.de</p>
        </a>
    </div>
    ...
    <div>
        ...
        <form
            class=" px-md py-xl flex flex-col"
